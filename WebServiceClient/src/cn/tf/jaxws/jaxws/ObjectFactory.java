 ...
 * generated in the cn.tf.jaxws.jaxws package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://jaxws.jaxws.tf.cn/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://jaxws.jaxws.tf.cn/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.tf.jaxws.jaxws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.jaxws.tf.cn/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.jaxws.tf.cn/", name = "queryWeatherResponse")
